...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 text-white text-xs font-bold px-5 py-3 rounded-full shadow-2xl uppercase tracking-wide transition-all hover:scale-105"
